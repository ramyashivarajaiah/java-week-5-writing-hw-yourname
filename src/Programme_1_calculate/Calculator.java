...
public class Calculator {
    ...
    public void addition(int a, int b) { // instance method with no return type with parameter
    ...
    // Method to calclate a result
    public void calculateResult(int a, int b, char symbol) { // using if and if else statement
        if (symbol == '+') { // == verifies if both operands are equal
            addition(a, b);
        } else if (symbol == '-') {
            subtraction(a, b);
        } else if (symbol == '/') {
